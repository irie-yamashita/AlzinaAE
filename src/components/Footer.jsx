...
function Footer() {
    ...
    return (
        <footer className="bg-primary p-10 xl:py-10 text-background flex flex-col xl:flex-row justify-center xl:justify-evenly items-stretch xl:items-center gap-6 xl:gap-4 w-full mt-12">
